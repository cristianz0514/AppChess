    ...
    chapters: [
      ...
      },
      {
        ...
        intro: [
          ...
          { speaker: "Judit", text: "Para cuando termine el torneo, lo van a saber.", side: "player", portrait: "judit-child" },
        ],
        outroWin: [
          ...
          { speaker: "Judit", text: "Entonces vamos por el siguiente paso.", side: "player", portrait: "judit-child" },
        ],
        outroLoseOrDraw: [
          { speaker: "László (papá)", text: "Jugar fuera de casa es distinto. Se aprende perdiendo también.", side: "other", portrait: "laszlo" },
          { speaker: "Judit", text: "Entonces ya aprendí lo que necesitaba.", side: "player", portrait: "judit-child" },
        ],
      },
      {
        ...
        intro: [
          ...
          { speaker: "Judit", text: "Entonces esta partida es nueva para los dos.", side: "player", portrait: "judit-child" },
        ],
        outroWin: [
          ...
          { speaker: "Judit", text: "No va a ser la última vez.", side: "player", portrait: "judit-child" },
        ],
        outroLoseOrDraw: [
          ...
          { speaker: "Judit", text: "Y ahora sé exactamente lo que tengo que superar.", side: "player", portrait: "judit-child" },
        ],
      },
      {
        ...
        intro: [
          ...
          { speaker: "Judit", text: "Todo récord tiene una primera vez en que se rompe.", side: "player", portrait: "judit-child" },
        ],
        outroWin: [
          ...
          { speaker: "Judit", text: "Ganamos juntas. Así se siente mejor.", side: "player", portrait: "judit-child" },
        ],
        outroLoseOrDraw: [
          ...
          { speaker: "Judit", text: "Difícil hoy. La próxima vez, distinto.", side: "player", portrait: "judit-child" },
        ],
      },
      {
        ...
        intro: [
          ...
          { speaker: "Judit", text: "Entonces los dos tenemos algo que perder.", side: "player", portrait: "judit-child" },
        ],
        outroWin: [
          ...
          { speaker: "Judit", text: "Esto es solo el principio de lo que quiero lograr.", side: "player", portrait: "judit-child" },
        ],
        outroLoseOrDraw: [
          { speaker: "GM Varga", text: "Esta vez me salvé. La próxima, no le prometo nada.", side: "other", portrait: "varga" },
          { speaker: "Judit", text: "No hace falta que me lo prometa. Yo se lo voy a demostrar.", side: "player", portrait: "judit-child" },
        ],
      },
      {
        ...
        intro: [
          ...
          { speaker: "Judit", text: "'Debería' es una palabra peligrosa antes de jugar conmigo.", side: "player", portrait: "judit-child" },
        ],
        outroWin: [
          { speaker: "GM Suárez", text: "…Retiro lo de 'trámite'.", side: "other", portrait: "suarez" },
          { speaker: "Judit", text: "Aceptado.", side: "player", portrait: "judit-child" },
        ],
        outroLoseOrDraw: [
          ...
          { speaker: "Judit", text: "Entonces ya empecé a ganarla.", side: "player", portrait: "judit-child" },
        ],
      },
      {
        ...
        intro: [
          ...
          { speaker: "Judit", text: "Lo sé. Por eso no pienso dejarlo pasar.", side: "player", portrait: "judit-child" },
        ],
        outroWin: [
          ...
          { speaker: "Judit", text: "Un paso más.", side: "player", portrait: "judit-child" },
        ],
        outroLoseOrDraw: [
          { speaker: "GM Petrov", text: "El récord va a tener que esperar un poco más.", side: "other", portrait: "petrov" },
          { speaker: "Judit", text: "Esperar no es lo mismo que no llegar.", side: "player", portrait: "judit-child" },
        ],
      },
      {
        ...
        intro: [
          ...
          { speaker: "Judit", text: "Entonces vamos a escribirlo.", side: "player", portrait: "judit-child" },
        ],
        outroWin: [
          ...
          { speaker: "Judit", text: "Esto no es el final. Apenas estoy empezando.", side: "player", portrait: "judit-child" },
        ],
        outroLoseOrDraw: [
          { speaker: "GM Halász", text: "El récord sigue esperando a alguien. Hoy no fue el día.", side: "other", portrait: "halasz" },
          { speaker: "Judit", text: "Habrá otro día. Y otra partida.", side: "player", portrait: "judit-child" },
        ],
      },
    ],
  },
