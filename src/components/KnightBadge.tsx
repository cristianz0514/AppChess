  ...
  return (
    <div
      ...
      style={{
        width: size,
        height: size,
        background: "radial-gradient(circle at 32% 28%, oklch(0.46 0.12 264), oklch(0.30 0.09 264) 78%)",
        boxShadow: active
          ? "0 5px 18px oklch(0.30 0.09 264 / 0.55), inset 0 1px 1.5px rgba(255,255,255,.35), inset 0 -3px 6px rgba(0,0,0,.28)"
          : "0 4px 14px oklch(0.30 0.09 264 / 0.4), inset 0 1px 1.5px rgba(255,255,255,.3), inset 0 -3px 6px rgba(0,0,0,.25)",
      }}
    >
      ...
      <svg viewBox="0 0 45 45" width={size * 0.52} height={size * 0.52} style={{ filter: "drop-shadow(0 1px 1px rgba(0,0,0,.3))" }} aria-hidden>
        ...
        <path d="M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0z" fill="oklch(0.30 0.09 264)" opacity=".55" />
      </svg>
      {active && (
